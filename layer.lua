...
function handle_key_03(pressed)
    press_layer_key(3, pressed)
end

function handle_key_04(pressed)
    press_layer_key(4, pressed)
end

function handle_key_05(pressed)
    press_layer_key(5, pressed)
end

function handle_key_06(pressed)
    press_layer_key(6, pressed)
end

function handle_key_07(pressed)
    press_layer_key(7, pressed)
end

function handle_key_08(pressed)
    press_layer_key(8, pressed)
end

function handle_key_09(pressed)
    press_layer_key(9, pressed)
end

function handle_key_10(pressed)
    press_layer_key(10, pressed)
end

function handle_key_11(pressed)
    press_layer_key(11, pressed)
end
